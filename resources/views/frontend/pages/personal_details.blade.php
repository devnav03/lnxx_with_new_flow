...
<div class="row">
  ...
  <div class="col-md-6" id="years_in_uae_div" @if($sel_country == 229) style="display: none;" @endif>
      ...
      <input name="years_in_uae" maxlength="2" pattern="\d*" id="years_in_uae" class="form-control" @if($sel_country != 229) @endif   @if($result) value="{{ $result->years_in_uae }}" @else value="{{ old('years_in_uae') }}" @endif type="text">
  ...
  <!--<div class="col-md-6">
    <div class="form-group">
      ...
      <select name="no_of_dependents" onChange="NoOfDependents(this);" class="form-control">
        <option value="">Select</option>
...
@endphp
  ...
  <div class="col-md-6">
    <div class="form-group">
      ...
      <input name="officer_email" class="form-control" required="true" maxlength="40" @if($result) value="{{ $result->officer_email }}" @else value="{{ old('officer_email') }}" @endif type="email">
...
<!--   <div class="col-md-12">
  ...
  <div class="col-md-12 text-center">
    ...
    <button type="submit" class="emirates_front_btn">Proceed</button>
  </div>
</div>
</form>
</div>
