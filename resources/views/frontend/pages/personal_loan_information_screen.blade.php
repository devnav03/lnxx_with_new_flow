...
<section class="personal_details" style="padding: 20px 0;">
<div class="container">  
<div class="row">  
<div class="col-md-7">
<div class="personal_details_box">
<h1 class="app_form_head" style="font-size: 20px;">Application Form</h1>
<h2 style="margin-bottom: 15px;font-size: 18px;">Personal loan information</h2>
<!-- <h6 style="margin-top: 12px;margin-bottom: 15px;">Please enter your information to check the offer.</h6> -->
<form action="{{ route('save-personal-loan-information_screen') }}" enctype="multipart/form-data" method="post">
{{ csrf_field() }}  
<div class="row">
  <div class="col-md-6">
 ...
 <!--  <div class="col-md-12">
  ...
  <div class="col-md-12">
     <label style="font-weight: normal; font-size: 13px; margin-top: 6px;"><input style="width: 20px; height: 20px; box-shadow: none; margin-right: 10px; margin-top: 10px; float: left;margin-bottom: 0px;" type="checkbox" name="acknowledge_receiving_key_fact_statement" @if($result) @if($result->acknowledge_receiving_key_fact_statement == "1") checked="" @endif @endif value="1"> I Acknowledge Receiving A Key Fact Statement (Kfs) Of This Product.</label>
  </div>

  <div class="col-md-12" style="margin-top: 10px;">
     <label style="font-weight: normal; font-size: 13px; margin-top: 6px;"><input style="width: 20px; height: 20px; box-shadow: none; margin-right: 10px; margin-top: 35px; float: left;margin-bottom: 25px;" type="checkbox" name="hereby_give_our_consent_to_waive" @if($result) @if($result->hereby_give_our_consent_to_waive == "1") checked="" @endif @endif value="1"> I/We Hereby Give Our Consent To Waive Of The Cooling-Off Period Of 5 Business<br> Days And Understand That The Bank'S Terms & Condition Are Applicable From The
Date Of Signing This Application By Me.</label>
  ...
  <div class="col-md-12">
     <label style="font-weight: normal; font-size: 13px; margin-top: 6px;"><input style="width: 20px; height: 20px; box-shadow: none; margin-right: 10px; margin-top: 28px; float: left;margin-bottom: 12px;" type="radio" name="murabaha_contract_or_proceeds_thereof" @if($result) @if($result->murabaha_contract_or_proceeds_thereof == "1") checked="checked" @endif @endif value="1"> Advise Us Your Custody Account Number With Enbds To Which The Asset Will Be Transferred Upon Completion Of The Murabaha Contract</label>
  </div>
  <div class="col-md-12">
     <label style="font-weight: normal; font-size: 13px; margin-top: 6px;"><input style="width: 20px; height: 20px; box-shadow: none; margin-right: 10px; margin-top: 25px; float: left;margin-bottom: 17px;" type="radio" name="murabaha_contract_or_proceeds_thereof" @if($result) @if($result->murabaha_contract_or_proceeds_thereof == "2") checked="checked" @endif @else checked="checked" @endif value="2"> To Authorise Enbds To Sell The Asset To Third Party On Your Behalf And Transfer The Sale Proceeds Thereof Into Your Account With Ei No.</label>
  </div>
...
<div class="col-md-5">
  <div class="service-step">
    <h3 style="font-size: 16px; line-height: 25px; margin-bottom: 0px;">All fields marked with an asterisk (*) are mandatory.</h3>
  </div>
  <div class="service-step">
    <h3 style="font-size: 16px; line-height: 25px; margin-bottom: 0px;">Complete and accurate information helps us bring you the best products suited to you at the fastest pace!</h3>
  </div>
</div>
</div>
</div>
...
<style type="text/css">
.personal_details_box input, .personal_details_box select {
