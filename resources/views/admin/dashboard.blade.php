                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <div class="card-item">
                            ...
                            <label style="line-height: 20px;min-height: 40px;cursor: pointer;" class="main-content-label tx-13 font-weight-bold mb-1">Total Application (Signed-Up Customer)</label>
                            </div>
                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <div class="card-item">
                            ...
                            <div class="card-item-title mb-2">
                            <label style="line-height: 20px;min-height: 40px;cursor: pointer;" class="main-content-label tx-13 font-weight-bold mb-1">New
                                    Applications (Last 30 Days)</label>
                            </div>
                            <div class="card-item-body">
                                <div class="card-item-stat">
                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <div class="card-item">
                            ...
                            <div class="card-item-title mb-2">
                                <label style="line-height: 20px;min-height: 40px;cursor: pointer;" class="main-content-label tx-13 font-weight-bold mb-1">Total Customers</label>
                            </div>
                            <div class="card-item-body">
                                <div class="card-item-stat">
                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <div class="card-item">
                            ...
                            <div class="card-item-title mb-2">
                            <label style="line-height: 20px;min-height: 40px;cursor: pointer;" class="main-content-label tx-13 font-weight-bold mb-1">New  Customers (Last 30 Days)</label>
                            </div>
                            <div class="card-item-body">
                                <div class="card-item-stat">
                ...
                <div class="card custom-card">
                    <div class="card-body">
                        <div class="card-item">
                            ...
                            <div class="card-item-title mb-2">
                            <label style="line-height: 20px;min-height: 40px;cursor: pointer;" class="main-content-label tx-13 font-weight-bold mb-1">Total Products</label>
                            </div>
                            <div class="card-item-body">
                                <div class="card-item-stat">
