...
<div class="agile-grids">   
    <div class="grids">       
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-header">Landing Page Slider Information<a class="btn btn-sm btn-primary pull-right" href="{!! route('landing-sliders.index') !!}" > <i class="fa fa-solid fa-arrow-left"></i> All Landing Page Sliders</a></h1>
            ...
            <div class="panel panel-widget forms-panel" style="float: left;width: 100%; padding-bottom: 20px;">
                <div class="forms">
                        <div class="form-grids widget-shadow" data-example-id="basic-forms"> 
                            ...
                            <div class="form-body">
                                @if($route == 'landing-sliders.create')
                                    {!! Form::open(array('method' => 'POST', 'route' => array('landing-sliders.store'), 'id' => 'ajaxSave', 'class' => '', 'files'=>'true')) !!}
                                @elseif($route == 'landing-sliders.edit')
                                    {!! Form::model($result, array('route' => array('landing-sliders.update', $result->id), 'method' => 'PATCH', 'id' => 'landing-sliders-form', 'class' => '', 'files'=>'true')) !!}
                                @else
                                    Nothing
                                @endif
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group"> 
                                            {!! Form::label('image', lang('Slider Image (600px*400px)'), array('class' => '')) !!}
