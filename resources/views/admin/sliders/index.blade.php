...
<div class="agile-grids">   
    <div class="grids">       
        <div class="row">
            <div class="col-md-12">                
                <h1 class="page-header">Sliders <a style="background: #5EB495; border-color: #5EB495;" class="btn btn-sm btn-primary pull-right" href="{!! route('sliders.create') !!}"> <i class="fa fa-plus fa-fw"></i> Add New Slider</a></h1>
                <div class="agile-tables">
                    <div class="w3l-table-info">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="card custom-card">
                                    <div class="card-body">
                                    <div>
                                    <h6 class="main-content-label mb-1">Slider Filter</h6>
                                    </div>
                                    <div class="panel-body row">
                                    <div class="col-md-12" style="margin-top: 15px;">
                                    {!! Form::open(array('method' => 'POST',
                                    'route' => array('sliders.paginate'), 'id' => 'ajaxForm')) !!}
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 margintop20">
                                            <div class="form-group">
                                                ...
                                                <a href="{!! route('services.index') !!}" class="btn btn-success">Reset Filter</a>
                        ...
                        <form action="{{ route('sliders.action') }}" method="post">
                        <!--     <div class="row"> -->
                           ...
                           <!--  </div> -->
                            <table id="paginate-load" data-route="{{ route('sliders.paginate') }}" class="table table-hover">
                            </table>
                        </form>
                    </div>
