...
<div class="agile-grids">   
    <div class="grids">       
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-header">Create Lead @if($route == 'leads.add_leads')<button type="button" class="btn tn-sm btn-primary pull-right" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-solid fa-arrow-up"></i>Bulk Upload Leads</button> @endif </h1>
