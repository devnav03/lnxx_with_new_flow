...
<table style="width: 100%">
    @if($orderdetails['profile_image'])
    <tr>
        <td colspan="2" style="padding-bottom: 10px;padding-top: 15px;"><img src="{{ $orderdetails['profile_image'] }}" style="width: 150px;"> </td>
    </tr>
    @endif
	<tr>
...
<!-- 	<tr>
	...
	<tr>
        ...
        <td style="border-bottom: 1px solid #f3f3f3;">
        	@foreach($orderdetails['country'] as $country1)       
...
<table style="width: 100%">
    ...
    <tr>
        ...
        <td style="border-bottom: 1px solid #f3f3f3;">
            @foreach($orderdetails['country'] as $country)       
...
<table style="width: 100%">
    ...
    @if(count($orderdetails['CardTypePreference']) != 0)
        <tr>
            ...
            <td style="border-bottom: 1px solid #f3f3f3;">
                ...
                $i = 1;
            	@endphp
                @foreach($orderdetails['CardTypePreference'] as $CardType)
...
<table style="width: 100%">
	...
	<tr>
        ...
        <td style="border-bottom: 1px solid #f3f3f3;">
        	@foreach($orderdetails['countries'] as $country)
...
@if(isset($Personalloanform['Personalloanform']))
