...
class Form extends Model {
    ...
    protected $fillable = [
        'name', 'label', 'status', 'section', 'form_type', 'created_at', 'updated_at', 'deleted_at'
    ];
    ...
    public function getForms($search = null, $skip, $perPage) {
        ...
        if (is_array($search) && count($search) > 0) {
            ...
            $f2 = (array_key_exists('form_type', $search)) ? " AND (form_type Like '%" .
                addslashes($search['form_type']) . "%')" : "";   
    ...
    public function totalForms($search = null)  {
