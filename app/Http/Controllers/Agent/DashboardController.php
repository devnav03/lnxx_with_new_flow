...
class DashboardController extends Controller {
    ...
    public function index() {
        ...
        $total_lead = Lead::where('alloted_to', $user_id)->count();
        $close_lead = Lead::where('alloted_to', $user_id)->where('lead_status', 'CLOSE')->count();
        $open_lead = Lead::where('alloted_to', $user_id)->where('lead_status', '!=', 'CLOSE')->count();
        
       return view('agent.dashboard', compact('total_lead', 'close_lead', 'open_lead'));
